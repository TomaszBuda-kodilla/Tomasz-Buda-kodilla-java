...
public class TaskListDaoTestSuite {
    ...
    private static final String LISTNAME = "Test: New listname";
    private static final String DESCRIPTION = "Test: New description";
    ...
    public void testNamedQueries() {
        ...
        List<Task> durationLongerThanTasks = taskDao.retrieveTasksWithDurationLongerThan(0);
